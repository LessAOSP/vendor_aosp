...
bacon: $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	@echo -e ${CL_CYN}"----------------------------------------------"${CL_CYN}
	@echo -e ${CL_CYN}" __          _ _ _ _ _   _ _ _ __   _ _ _ __  "${CL_CYN}
	@echo -e ${CL_CYN}"|  |        |   _ _   | |   _ _ _| |   ___  | "${CL_CYN}
	@echo -e ${CL_CYN}"|  |   By   |  |   |  | |  |_ _ _  |  |___| | "${CL_CYN}
	@echo -e ${CL_CYN}"|  |Aghora7 |  |   |  | |_ _ _   | |   _ _ _| "${CL_CYN}
	@echo -e ${CL_CYN}"|  |______  |  |_ _|  |  _ _ _|  | |  |       "${CL_CYN}
	@echo -e ${CL_CYN}"|_ _ _ _ _| |_ _ _ _ _| |_ _ _ __| |__|       "${CL_CYN}
	@echo -e ${CL_CYN}"----------------------------------------------"${CL_CYN}   
	@echo -e ${CL_CYN}""${CL_CYN}
	...
	@echo -e ${CL_CYN}"===========-----Thank you for being a member of LessAOSP(LOSP) Family-----==========="${CL_RST}
	@echo -e ""